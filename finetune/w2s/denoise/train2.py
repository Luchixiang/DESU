...
def main():
   ...
   # weight = '/home/cxlu/desu/weight_1e-3_selected_16_uniform/best.pt'
    weight = '/home/cxlu/desu/weight_1e-3_selected_mmd_16_2/best.pt'
    ...
    for epoch in range(opt.epochs):
        ...
        model_dir = os.path.join(f'../net_data/trained_denoisers_avg{opt.img_avg}_{opt.model}2', model_name)
