...
parser.add_argument('--data-root', default='/userhome/34/cxlu/10/fmdd', type=str, help='dir to dataset')
parser.add_argument('--pretrain-dir', default='./experiment_full/dncnn_np/Jun_25/dncnn_noise_train[1, 2, 4, 8, 16]_test[1]_captures50_four_crop_epochs400_bs8_lr0.0001', type=str, help='dir to pre-trained model')
