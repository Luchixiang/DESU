...
class BaseOptions(object):
    def __init__(self):
        ...
        parser.add_argument('--batch_size', type=pos_int, default=64,
                            help='input batch size for training (default: 1024)')
        parser.add_argument('--test_batch_size', type=pos_int, default=64,
        ...
        parser.add_argument('--distill_lr', type=float, default=0.002,
        ...
        parser.add_argument('--distill_steps', type=pos_int, default=5,
        ...
        parser.add_argument('--test_n_nets', type=pos_int, default=5,
